...
public class ExcelTest2Model extends BaseRowModel {
    @ExcelProperty(value = {"表头1", "表头1", "表头12"}, index = 0)
    protected String p1;

    @ExcelProperty(value = {"表头1", "表头1", "表头13"}, index = 1)
    protected String p2;

    @ExcelProperty(value = {"表头2", "表头2", "表头2"}, index = 2)
    private int p3;

    @ExcelProperty(value = {"表头3", "表头3", "表头31"}, index = 3)
    private long p4;

    @ExcelProperty(value = {"表头5", "表头5", "表头51"}, index = 4)
    private String p5;

    @ExcelProperty(value = {"表头5", "表头5", "表头52"}, index = 5)
    private float p6;
