...
public class ExcelWriteTest {
     ...
     */
    @Test
    public void exportCrossReportWithTemplate() {
...
//        String outTemplate = "D:\\导出模板\\exportTemplateCrossDeptToMonth.xlsx";
        List<ExcelTable> excelTables1List = new ArrayList<>();
        List<ExcelTable> tbList = new ArrayList<>();
        int tableNo = 1;
//        List<CrossReportGroupModel> testTemplateCrossReportTestModel = TestData.emptyDataModel();
...
//        excelWriteParam.setEncryptPwd("lzg");
    ...
    public void exportV2007() {
        ...
        excelTable1.setFirstRowIndex(10);
        excelTable1.setNeedHead(false);
        ...
        excelTable4.setSpaceNum(2);
        excelTable4.setNeedHead(false);
        excelTable4.setTableLayoutEnum(TableLayoutEnum.BOTTOM);
        ExcelTable excelTable5 = new ExcelTable(5, null, ExportTestModel.class, TestData.createTestListJavaMode());
        excelTable5.setSpaceNum(1);
        excelTable5.setNeedHead(false);
        ...
        excelWriteParam.setExcelTemplateFile(outTemplate);
        excelWriteParam.setExcelSheets(sheets);
        ExcelWriteResponse export = IRISExcelFileFactory.exportV2007WithTemplate(excelWriteParam);
        System.out.println("------------------------export result start-----------------");
        System.out.println(JSONUtil.objectToString(export));
        System.out.println("------------------------export result end-----------------");
        Assert.assertEquals(export.getCode(), FileConstant.SUCCESS_CODE);
