    ...
    public void addContent(ExcelTable table) {
        ...
        if (context.isNeedInputTemplate()) {
            ...
            if (null != excelShiftRange) {
                ...
                currentSheet.shiftRows(excelShiftRange.getStartRow(), excelShiftRange.getEndRow() > 0
                        ...
                        excelShiftRange.getShiftNumber(), excelShiftRange.isCopyRowHeight(), excelShiftRange.isResetOriginalRowHeight());
            }
        }
...
//            StyleUtil.buildCellBorderStyle(currentCellStyle, 0, i == 0 && !table.isNeedHead(), BorderEnum.TOP);
    ...
    public static String getDicValue(Integer str1, Integer str2, BiFunction<Integer, Integer, String> function) {
