...
public class IRISExcelFileFactory {
    ...
    public static ExcelWriteResponse exportV2007(ExcelWriteParam param, InputStream inputStream) {
        ...
        log.warn("导出Excel耗时：{}{}", (System.currentTimeMillis() - startTime), "毫秒");
    ...
    public static ExcelWriteResponse exportV2007WithTemplate(ExcelWriteParam param) {
        return exportV2007WithTemplate(param, null);
    }
    ...
    public static ExcelWriteResponse exportV2007WithTemplate(ExcelWriteParam param, InputStream inputStream) {
        ...
        return exportV2007(param, inputStream);
    }
